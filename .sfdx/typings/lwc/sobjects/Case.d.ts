...
declare module "@salesforce/schema/Case.CSAT__c" {
  const CSAT__c:number;
  export default CSAT__c;
}
declare module "@salesforce/schema/Case.Case_ExternalId__c" {
  const Case_ExternalId__c:string;
  export default Case_ExternalId__c;
}
declare module "@salesforce/schema/Case.FCR__c" {
  const FCR__c:boolean;
  export default FCR__c;
}
declare module "@salesforce/schema/Case.Product_Family_KB__c" {
...
declare module "@salesforce/schema/Case.SLA_Type__c" {
