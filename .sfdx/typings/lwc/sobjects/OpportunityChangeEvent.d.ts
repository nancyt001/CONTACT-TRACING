...
declare module "@salesforce/schema/OpportunityChangeEvent.On_Hold__c" {
  const On_Hold__c:boolean;
  export default On_Hold__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Profile__c" {
  const Profile__c:string;
  export default Profile__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Opportunity_Source__c" {
  const Opportunity_Source__c:string;
  export default Opportunity_Source__c;
}
