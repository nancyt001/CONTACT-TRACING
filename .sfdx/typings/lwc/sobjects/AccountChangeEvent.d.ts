...
declare module "@salesforce/schema/AccountChangeEvent.Avg_Case_Resolution_Days__c" {
  const Avg_Case_Resolution_Days__c:number;
  export default Avg_Case_Resolution_Days__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Segment__c" {
  const Segment__c:string;
  export default Segment__c;
}
